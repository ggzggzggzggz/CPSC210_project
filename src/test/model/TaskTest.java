...
//        assertFalse(test1.checkEqual(test2));
//        assertFalse(test1.checkEqual(test3));
//        assertFalse(test1.checkEqual(test4));
//        assertTrue(test1.checkEqual(test1));
//        assertTrue(test1.checkEqual(test5));
//    }
}